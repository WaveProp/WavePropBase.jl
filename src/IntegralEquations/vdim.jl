function vdim_correction(pde,X,Y,Γ,S,D,V;location,order)
    ...
    σ = location === :onsurface ? -0.5 : location === :inside ? -1.0 : location === :outside ? 0.0 : error(msg)
...
function _basis_vdim(::Laplace{2},order)
    ...
    R,P,dP = (R...,r_20,r_11,r_02), (P...,p_20,p_11,p_02), (dP...,dp_20,dp_11,dp_02)
...
function _basis_vdim(::Laplace{3},order)
    ...
    R,P,dP = (R...,r_100,r_010,r_001), (P...,p_100,p_010,p_001), (dP...,dp_100,dp_010,dp_001)
    order == 1 && return R,P,dP
    notimplemented()
    # P2
end
